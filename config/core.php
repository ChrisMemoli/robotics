 ...
 */
	Configure::write('Security.salt', 'giun58nkDFHGDFHe44SS8ngkavnjeedDg4224Dsshaj');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '584787640373875378957938654306738029777205');
