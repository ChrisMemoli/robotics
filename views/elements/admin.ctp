<h3><?php __('Pages'); ?></h3>
	<ul>
		...
		<li><?php echo $this->Html->link(__('Robots', true), array('controller' => 'contents', 'action' => 'edit', 4))?></li>
		<li><?php echo $this->Html->link(__('Members', true), array('controller' => 'contents', 'action' => 'edit', 5))?></li>
		<li><?php echo $this->Html->link(__('Software', true), array('controller' => 'contents', 'action' => 'edit', 6))?></li>
		<li><?php echo $this->Html->link(__('Courses', true), array('controller' => 'contents', 'action' => 'edit', 7))?></li>
	
	
	</ul>
<br />
<h3><?php ('Other Actions'); ?></h3>
	<ul>
